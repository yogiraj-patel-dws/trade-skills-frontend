...
export const SkillCard = ({ skill }: SkillCardProps) => {
  ...
  return (
    <div
      onClick={() => navigate(ROUTES.SKILL_DETAIL)}
      className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow w-full"
    >
      <div className="relative h-48 overflow-hidden">
        ...
        />
        <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-md flex items-center gap-1 shadow-sm">
